...
@Entity
@Table(name = "pag_orchestra")
@SequenceGenerator(name = "pag_orchestra_seq", sequenceName = "pag_orchestra_id_seq")
public class PagellaOrchestra {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pag_orchestra_seq")
	private int id;
	...
	@ManyToOne
	@JoinColumn(name = "idorchestra", nullable = false)
	...
	public String toString() {
		return "Pagella: " + orchestra + ", " + studente;
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((orchestra == null) ? 0 : orchestra.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		PagellaOrchestra other = (PagellaOrchestra) obj;
		if (anno != other.anno) return false;
		if (orchestra == null) {
			if (other.orchestra != null) return false;
		} else if (!orchestra.equals(other.orchestra)) return false;
		if (studente == null) {
