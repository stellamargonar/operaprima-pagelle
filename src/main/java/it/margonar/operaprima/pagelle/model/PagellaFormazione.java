...
@Entity
@Table(name = "pag_formazione")
@SequenceGenerator(name = "pag_formazione_seq", sequenceName = "pag_formazione_id_seq")
public class PagellaFormazione {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pag_formazione_seq")
	private int id;
	...
	public String toString() {
		return "Pagella: formazione " + studente;
	}
	...
	public boolean equals(Object obj) {
		...
		PagellaFormazione other = (PagellaFormazione) obj;
