...
@Entity
@Table(name = "pag_laboratorio")
@SequenceGenerator(name = "pag_laboratorio_seq", sequenceName = "pag_laboratorio_id_seq")
public class PagellaLaboratorio {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pag_laboratorio_seq")
	private int id;
	...
	public String toString() {
		return "Pagella: " + laboratorio + ", " + studente;
	}
	...
	public boolean equals(Object obj) {
		...
		PagellaLaboratorio other = (PagellaLaboratorio) obj;
		if (anno != other.anno) return false;
		if (laboratorio == null) {
			if (other.laboratorio != null) return false;
		} else if (!laboratorio.equals(other.laboratorio)) return false;
		if (studente == null) {
