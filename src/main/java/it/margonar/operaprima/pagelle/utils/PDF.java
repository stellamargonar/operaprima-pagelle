...
public class PDF {
	...
	private void newPage() throws MalformedURLException, IOException,
			DocumentException {
		document.newPage();
		logo();
	}

	public String createPDF(Summary summary) throws DocumentException,
		...
		PdfWriter.getInstance(document, new FileOutputStream(pagellePath
				+ "/pagella_" + s.getStudente().getCognome() + "_"
				+ s.getStudente().getNome() + "_" + s.getStudente().getId()
				+ ".pdf"));
		document.open();
	...
	private void signature() throws DocumentException,
	...
	private void tabellaAnagrafica() throws DocumentException {
		...
		PdfPCell dx = new PdfPCell(new Phrase(stu.getCognome() + " "
				+ stu.getNome(), font));
		setPropertiesDX(dx);
		t1.addCell(dx);
		...
		sx.setPhrase(new Phrase(40, "Iscritto alla Scuola dal", grassetto));
		t1.addCell(sx);
	...
	private void tabellaCorsi() throws DocumentException, SQLException {
		...
		PdfPCell sx = new PdfPCell(new Phrase(40, "A - CORSO 1: Strumento",
				grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
		...
		sx = new PdfPCell(new Phrase(40, "B - CORSO 2: Formazione Musicale",
				grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
		...
		sx = new PdfPCell(new Phrase(40, "C - CORSO 3: Laboratorio Musicale",
				grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
		...
		sx = new PdfPCell(new Phrase(40, "D - CORSO 4: Educazione Corali",
				grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
		...
		sx = new PdfPCell(new Phrase(40,
				"E - CORSO 5: Laboratorio Orchestrale", grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
		...
		sx = new PdfPCell(new Phrase(40,
				"F - CORSO 6: Cultura Musicale / Altro", grassetto));
		setPropertiesSX(sx);
		t1.addCell(sx);
	...
	private void tabellaStrumento() throws DocumentException, SQLException {
		// 2 tabella: STRUMENTO
		// intestazione
		PdfPCell titolo = new PdfPCell(new Phrase(40, "Cognome e Nome",
				grassetto));
		...
		titolo.setPhrase(new Phrase(40, "DOCENTE del Corso: "
				+ (!empty ? doc.getCognome() + " " + doc.getNome() : ""),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);

		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del Corso "
				+ (empty ? "" : ps.getSede()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Anno di studi "
				+ (empty ? "" : ps.getAnno()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || ps.getAssenze() == null ? "" : ps.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
		...
		PdfPCell name = new PdfPCell(new Phrase(40, "TESTI STUDI e TECNICA",
				font2));
		setPropertiesName(name);
		ts.addCell(name);

		PdfPCell value = new PdfPCell(new Phrase(empty ? "" : ps.getTesti(),
				font));
		...
		for (int i = 0; i < competenzeStrumento.size(); i++) {
			name.setPhrase(new Phrase(competenzeStrumento.get(i) + " (1-5)",
					font2));
			tcomp.addCell(name);
			int comp = empty ? 0 : ps.getCompetenza(i);
			value.setPhrase(new Phrase(empty ? "" : comp > 0 ? Integer
					.toString(comp) : "", font2));
			tcomp.addCell(value);
		}
		...
		value.setPhrase(new Phrase(40, "Complessivo: "
				+ (empty ? "" : ps.getNote()), font2));
	...
	private void logo() throws MalformedURLException, IOException,
			DocumentException {
	...
	private void tabellaFormazione() throws DocumentException, SQLException {
		...
		PdfPTable ts = new PdfPTable(1);
		titolo.setPhrase(new Phrase(40, "B - CORSO 2: Formazione Musicale",
				grassetto));
		ts.addCell(titolo);
		...
		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del Corso "
				+ (empty ? "" : pf.getSede()), grassetto));
		ts.addCell(titolo);

		titolo.setPhrase(new Phrase(40, "Corso B1", grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || pf.getAssenze() == null ? "" : pf.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
		...
		PdfPCell name = new PdfPCell(new Phrase(40, "TESTI PROGRAMMA SVOLTO",
				font2));
		setPropertiesName(name);
		ts.addCell(name);

		PdfPCell value = new PdfPCell(new Phrase(empty ? "" : pf.getTesti(),
				font));
		setPropertiesValue(value);
		ts.addCell(value);
		...
		for (int i = 0; i < competenzeFormazione.size(); i++) {
			name.setPhrase(new Phrase(competenzeFormazione.get(i) + "(1-5)",
					font2));
			tcomp.addCell(name);
	...
	private void tabellaLaboratorio() throws DocumentException, SQLException {
		...
		titolo.setPhrase(new Phrase(40, "C - CORSO 3: Laboratorio Musicale"
				+ (empty ? "" : "( " + pl.getLaboratorio().getNome() + " )"),
				grassetto));
		ts.addCell(titolo);
		...
		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del Corso "
				+ (empty ? "" : pl.getSede()), grassetto));
		ts.addCell(titolo);

		titolo.setPhrase(new Phrase(40, "Anno di Laboratorio "
				+ (empty ? "" : pl.getAnno()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || pl.getAssenze() == null ? "" : pl.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
		...
		PdfPCell name = new PdfPCell(new Phrase(40,
				"REPERTORIO e PERCORSO MUSICALE", font2));
		setPropertiesName(name);
		ts.addCell(name);

		PdfPCell value = new PdfPCell(new Phrase(empty ? ""
				: pl.getRepertorio(), font));
		setPropertiesValue(value);
		ts.addCell(value);
	...
	private void tabellaOrchestra() throws DocumentException, SQLException {
		...
		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del corso "
				+ (empty ? "" : po.getSede()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Anno di corso "
				+ (empty ? "" : po.getAnno()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || po.getAssenze() == null ? "" : po.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
		...
		PdfPCell name = new PdfPCell(new Phrase(40,
				"REPERTORIO PERCORSO MUSICALE", font2));
		setPropertiesName(name);
		ts.addCell(name);

		PdfPCell value = new PdfPCell(new Phrase(empty ? ""
				: po.getRepertorio(), font));
		setPropertiesValue(value);
		ts.addCell(value);
	...
	private void tabellaCoro() throws DocumentException, SQLException {
		...
		PdfPTable ts = new PdfPTable(1);
		titolo.setPhrase(new Phrase(40, "D - CORSO 4: Esercitazioni Corali ",
				grassetto));
		ts.addCell(titolo);
		...
		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del corso "
				+ (empty ? "" : pc.getSede()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Anno di corso "
				+ (empty ? "" : pc.getAnno()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || pc.getAssenze() == null ? "" : pc.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
	...
	private void tabellaAltro() throws DocumentException, SQLException {
		...
		titolo.setPhrase(new Phrase(40,
				"F - CORSO 6: Cultura Musicale o altra Esperienza Formativa",
				grassetto));
		ts.addCell(titolo);
		...
		ts = new PdfPTable(3);
		titolo.setPhrase(new Phrase(40, "Sede del corso "
				+ (empty ? "" : pa.getSede()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Anno di corso "
				+ (empty ? "" : pa.getAnno()), grassetto));
		ts.addCell(titolo);
		titolo.setPhrase(new Phrase(40, "Assenze "
				+ (empty || pa.getAssenze() == null ? "" : pa.getAssenze()),
				grassetto));
		ts.addCell(titolo);
		document.add(ts);
	...
	private void tabellaEsame() throws DocumentException, SQLException {
		...
		titolo = new PdfPCell(new Phrase(40, "Data " + formatDate(e.getData()),
				grassetto));
		setPropertiesSX(titolo);
		titolo.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
		titolo.setBorder(0);
		...
		PdfPCell name = new PdfPCell(new Phrase(40, "Membri della Commissione",
				font2));
		setPropertiesName(name);
		ts.addCell(name);
